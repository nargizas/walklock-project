...
@Composable
fun HealthConnectApp(healthConnectManager: HealthConnectManager, dataStore: DataStore<Preferences>, bluetoothSocket: BluetoothSocket) {
  HealthConnectTheme {
