...
class HealthConnectManager(private val context: Context) {
  ...
  // Create a function to convert ZonedDateTime to a string
  ...
  suspend fun readStepsCounts(start: Instant, end: Instant): List<StepsRecord> {
    val request = ReadRecordsRequest(
  ...
  suspend fun getTotalSteps(start: Instant, end: Instant): Long {
    ...
    result[StepsRecord.COUNT_TOTAL]?.let {
      Log.d("TAG", "sending the value" + result[StepsRecord.COUNT_TOTAL].toString())
